...
public struct StorageKey: RawRepresentable, Hashable, Sendable {
    ...
    public static let biometricEnabled = StorageKey("com.socialsa.trustnet.biometricEnabled")
    /// Last email successfully used to sign in, prefilled on the sign-in screen.
    public static let lastSignedInEmail = StorageKey("com.socialsa.trustnet.lastSignedInEmail")
    /// Whether the welcome screen has ever been shown.
    public static let hasSeenWelcome = StorageKey("com.socialsa.trustnet.hasSeenWelcome")
}
