...
public struct WallPresentation: Equatable, Sendable {
    ...
    /// Badge colouring.
    public let badgeStyle: TNBadge.Style
    ...
    public static func make(for status: VerificationStatus) -> WallPresentation {
        ...
        case .unstarted:
            return WallPresentation(
                ...
                message: "TrustNet only admits verified humans. Scan your government ID and complete a short liveness check — it takes about three minutes.",
        ...
        case .verified:
            return WallPresentation(
                ...
                message: "Welcome to TrustNet. Every account you'll see here belongs to a real, verified human.",
                badgeText: "Verified",
                badgeStyle: .verified,
                primaryActionTitle: "Enter TrustNet",
                showsProcessingAnimation: false
            )
        case .rejected:
            return WallPresentation(
