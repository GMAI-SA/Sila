...
///
/// > Note: The spec specifies phone + password. TrustNet Phase 1 is
/// > email-first.
@MainActor
public struct SignInScreen: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: TNSpacing.lg) {
                ...
                TNTextField(
                    ...
                    accessibilityHint: "The email address on your TrustNet account",
                    submitLabel: .next,
                ...
                TNTextField(
                    ...
                    accessibilityHint: "The password for your TrustNet account",
                    submitLabel: .go,
                ...
                if viewModel.showsBiometricButton {
                    VStack(spacing: TNSpacing.md) {
                        ...
                        TNButton(
                            ...
                            accessibilityHint: "Unlocks your saved TrustNet session using \(viewModel.biometry.displayName)"
                        ) {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: TNSpacing.sm) {
            ...
            Text("Sign in to your verified TrustNet account.")
