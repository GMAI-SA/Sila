...
public enum PasswordStrength: Int, Comparable, CaseIterable, Sendable {
    ...
    /// The minimum length Sila accepts.
    ...
    /// Fill fraction for ``SLProgressBar``.
    ...
    public var color: Color {
        switch self {
        case .weak: return SLColor.danger
        case .fair: return SLColor.warning
        case .good: return SLColor.primary
        case .strong: return SLColor.secondary
        }
    }
